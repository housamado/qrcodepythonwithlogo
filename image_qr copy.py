...
def generate_qr_code_with_logo(data, logo_path, output_filename):
    ...
    # Générer le code QR avec une haute correction d'erreur
    qr = segno.make(data, error='H')

    # Enregistrer le code QR dans un fichier image temporaire
    qr.save('temp_qr_code.png', scale=10)  # Ajustez l'échelle si nécessaire
